...
Sprawling suburbs, deteriorating public transit systems and persistent racial and economic segregation are all examples of urbanism gone wrong. Bad urbanism is the result of public policies created in an environment of political short-termism and misaligned incentives that creates the conditions for such failures. These urban ills are wound up in a feedback loop where ineffective leadership and policy begets inequitable, stagnant urbanism, which in turn contributes to ballooning budget deficits, declining service quality and distrust of public officeholders.
...
>"If California had added 210,000 new housing units each year over the past three decades… population would be much greater than it is today. We estimate that around 7 million additional people would be living in California. In some areas, particularly the Bay Area, population increases would be dramatic. For example, San Francisco's population would be more than twice as large."
...
In a perfect world, this kind of people-centric planning and design would be the norm, not an exception. Communities with forward-thinking residents facing immense growth pressure like Boston, San Francisco and Austin would ideally become the heart of the Lean Urbanism movement. Unfortunately, in 5 years Lean Urbanism has yet to scale its vision much beyond infrequent pilot projects.
...
Housing prices are rising due to a shortage of available units for new residents, and a group of neighbors thinks that a mixed-use building with apartments and commercial space should be built in your town to accommodate new residents. Given demand, there are also probably several developers who are eager to build such a project. After all, the more building a developer can fit on a parcel, the more they can profit. However, it’s unlikely that such a project will ever be built.

Why? Because current zoning laws in most communities don’t allow such a building and it’s much easier to deliver projects that meet a well-defined and predictable form than to take on the burden of challenging the status quo. There are three categories of stakeholders that need to be addressed: municipal planning boards, residents and real estate developers.

Given the decades-long impacts of developments, municipal planning boards are rightly risk averse and likely to give in to the protests of a loud minority. Even if a developer could get the municipality on board for a zoning change, backlash from NIMBY (Not In My Back Yard) residents isn’t worth it. It’s a well-known fact in urban planning circles that opponents to a project are much more likely to voice their opinions in public hearings than supporters.
...
Residents have far more diverse opinions on zoning and development reform, but most people care most about housing costs, neighborhood amenities and property values. Lean Urbanism promises to lower housing costs due to cheaper construction and denser housing development, while also empowering businesses to easily set up shop in more areas. However, resident antipathy towards development—and change in general—is still evident. As a result, individuals are unlikely to look favorably upon the relaxed permitting requirements of Lean Urbanist planning regimes.
...
It’s no surprise that Lean Urbanism hasn’t been successful in winning supporters over the past 5 years. Aligning several heterogeneous stakeholder groups in systems as complex as those in American cities is incredibly difficult. So is upending paradigms in urban planning and development that have been entrenched for a hundred years.
